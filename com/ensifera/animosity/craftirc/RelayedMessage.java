...
public class RelayedMessage {
    ...
    public String getMessage(EndPoint currentTarget) {
        ...
        //Convert colors
        if (source.getType() == EndPoint.Type.MINECRAFT && realTarget.getType() == EndPoint.Type.IRC) {
            /*
        ...
        if (source.getType() == EndPoint.Type.IRC && realTarget.getType() == EndPoint.Type.MINECRAFT) {
            /*
